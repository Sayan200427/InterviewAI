import maleVideo from "../assets/Videos/male-ai.mp4"; // Fixed: capital V
import femaleVideo from "../assets/Videos/female-ai.mp4";
import Timer from "./Timer";
import { motion } from "motion/react"; // Assuming framer-motion v12+, otherwise use "framer-motion"
import { FaMicrophone, FaMicrophoneSlash } from "react-icons/fa";
import { useState, useRef, useEffect } from "react";
import axios from "axios"; // Added: useEffect
import { ServerUrl } from "../App";
import { BsArrowRight } from "react-icons/bs"; // Assuming you have a ServerUrl defined in App.js
    ...
    const runIntro = async () => {
      if (isIntroPhase) {
        ...
        if (currentIndex === questions.length - 1) {
          await speakText(
            "Alright, this one might be a bit more challenging. Take your time and do your best.",
          );
        }
            ...
            <div className="flex items-center gap-4 mt-6">
              <motion.button
                ...
                className={`w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center rounded-full shadow-lg transition-colors ${
                  isMicOn ? "bg-red-500 text-white" : "bg-black text-white"
                }`}
              >
                {isMicOn ? (
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="flex-1 bg-gradient-to-r from-emerald-600 to-teal-500 text-white py-3 sm:py-4 rounded-2xl shadow-lg hover:opacity-90 transition font-semibold disabled:bg-gray-500 disabled:from-gray-500 disabled:to-gray-500"
              >
