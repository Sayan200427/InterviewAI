      ...
      <div className="flex-1 px-6 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex justify-center mb-6">
            <div className="flex items-center gap-2 bg-gray-100 text-gray-600 text-sm px-4 py-2 rounded-full">
          ...
          {/* Steps Section */}
          <div className="flex flex-col md:flex-row justify-center items-center gap-10 mt-12 md:mt-16 mb-28">
            {[
              {
